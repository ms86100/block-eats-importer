  ...
  if (posts.length === 0 && helpCount === 0) {
    return (
      <div className="px-4 mt-6 mb-4">
        ...
        <Link to="/community">
          <div className="bg-primary/5 border border-primary/10 rounded-2xl px-4 py-8 text-center active:scale-[0.98] transition-transform">
            <MessageCircle size={28} className="text-primary mx-auto mb-2.5 opacity-60" />
            <p className="text-sm font-bold text-foreground">Be the first to post!</p>
            <p className="text-[11px] text-muted-foreground mt-1.5">Share updates, ask questions, or help a neighbor</p>
          </div>
        </Link>
      </div>
    );
        ...
        {helpCount > 0 && (
          <Link to="/community">
            <motion.div
              ...
              className="bg-warning/10 border border-warning/20 rounded-2xl px-4 py-3.5 flex items-center gap-3 active:scale-[0.98] transition-transform"
            >
        ...
        {posts.map((post, i) => (
          <Link key={post.id} to="/community">
            <motion.div
              ...
              className="bg-card border border-border rounded-2xl px-4 py-3.5 flex items-center gap-3 active:scale-[0.98] transition-all hover:border-primary/20 hover:shadow-sm"
            >
              <div className="flex-1 min-w-0">
